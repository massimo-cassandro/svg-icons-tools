...
const config = {
  ...
  symbols: {
     ...
     */
    source_folders: ['svg-src-fill', 'svg-src-stroke'],
  ...
  svg_to_scss: {
     ...
     */
    files: [
      './svg-src-stroke/heroicons-outline-adjustments-vertical.svg',
      './svg-src-fill/phosphoricons-airplane-tilt.svg',
      './svg-src-fill/this-file-doesnt-exist.svg',
    ],
